...
Gem::Specification.new do |s|
  ...
  s.authors     = ['Sébastien Gaya', 'Arnaud Levy', 'Pierre-André Boissinot', 'Antoine Prévost', 'Alexis Rousseau', 'Steven Ing']
  s.email       = ['sebastien.gaya@gmail.com', 'alevy@lespoupees.paris', 'paboissinot@lespoupees.paris', 'aprevost@lespoupees.paris', 'arousseau@lespoupees.paris', 'sing@lespoupees.paris']
